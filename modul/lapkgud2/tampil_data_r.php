...
$tgl_akhir = date('Y-m-t', strtotime($kode1a));
//ambil bulan saja
...
$yr1 = date('Y', strtotime($kode1));
	...
	//echo "<br>".$sql1."<br>";	
		...
		//tanpa value
		echo "<tr><td colspan='7'><b>Saldo Awal ".SaldoAwalStok($kode2,$tglD,$cabang)[2]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,$tglD,$cabang)[0])."</td><td align='right'><b></td></tr>";
		$mth = date('m', strtotime($tglD));
		$sqlg	= "SELECT IFNULL((SAwal$mth ),0) AS unit,IFNULL((VAwal$mth),0) AS val, Gudang FROM `dinventorysummary` WHERE `Produk`='$kode2' AND `cabang`='$cabang' ORDER BY Gudang";		
...
//		echo "<tr><td colspan='5'>Gudang ".$g_data[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($g_data[unit])."</td><td align='right'>".format_rupiah($g_data[val])."</td><td align='right' colspan='2'></td></tr>";		
		echo "<tr><td colspan='5'>Gudang ".$g_data[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($g_data[unit])."</td><td align='right'></td><td align='right' colspan='2'></td></tr>";		
		}
		$tglcek = date('Y-m-01', strtotime($kode1a));
...
//			echo "<tr><td colspan='7'><b>Saldo Sekarang ".$hari_ini." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,$tglD,$cabang)[3])."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,$tglD,$cabang)[4])."</td></tr>";
			echo "<tr><td colspan='7'><b>Saldo Sekarang ".$hari_ini." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,$tglD,$cabang)[3])."</td><td align='right'><b></td></tr>";
			$sqlgs	= "SELECT IFNULL((`Unit Stok`),0) AS unit,IFNULL((`Value Stok`),0) AS val, Gudang FROM `dinventorysummary` WHERE `Produk`='$kode2' AND `cabang`='$cabang' ORDER BY Gudang";		
...
//			echo "<tr><td colspan='5'>Gudang ".$gs_data[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($gs_data[unit])."</td><td align='right'>".format_rupiah($gs_data[val])."</td><td align='right'  colspan='2'></td></tr>";		
			echo "<tr><td colspan='5'>Gudang ".$gs_data[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($gs_data[unit])."</td><td align='right'></td><td align='right'  colspan='2'></td></tr>";		
			}
 		}
		else
		{
...
//			echo "<tr><td colspan='7'><b>Saldo Awal ".SaldoAwalStok($kode2,date('Y-m-d', strtotime($tglD. ' + 1 months')),$cabang)[2]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,date('Y-m-d', strtotime($tglD. ' + 1 months')),$cabang)[0])."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,date('Y-m-d', strtotime($tglD. ' + 1 months')),$cabang)[1])."</td></tr>";
			echo "<tr><td colspan='7'><b>Saldo Awal ".SaldoAwalStok($kode2,date('Y-m-d', strtotime('m',$tglDa.' + 1 month')),$cabang)[2]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,date('Y-m-d', strtotime($tglDa. ' + 1 months')),$cabang)[0])."</td><td align='right'><b></td></tr>";
			echo "<tr><td colspan='7'><b>Saldo Awal-".SaldoAwalStok($kode2,date('Y-m-d', mktime(0,0,0,date('m',$tglDa),date('d',$tglDa),date('Y',$tglDa))),$cabang)[2]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'><b>".format_rupiah(SaldoAwalStok($kode2,date('Y-m-d', strtotime($tglDa. ' + 1 months')),$cabang)[0])."</td><td align='right'><b></td></tr>";
			$mth1 = date('m', strtotime($tglDa.' + 1 months'));
			$sqlg1	= "SELECT IFNULL((SAwal$mth1 ),0) AS unit,IFNULL((VAwal$mth1),0) AS val, Gudang FROM `dinventorysummary` WHERE `Produk`='$kode2' AND `cabang`='$cabang' ORDER BY Gudang";		
...
//			echo "<tr><td colspan='5'>Gudang ".$g_data1[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($g_data1[unit])."</td><td align='right'>".format_rupiah($g_data1[val])."</td><td align='right' colspan='2'></td></tr>";		
			echo "<tr><td colspan='5'>Gudang ".$g_data1[Gudang]." : ".$hasilProd['kodep']." - ".$hasilProd['nama']."</td><td align='right'>".format_rupiah($g_data1[unit])."</td><td align='right'></td><td align='right' colspan='2'></td></tr>";		
			}
 		} 
 		echo "</table>";
	echo "</div>";
