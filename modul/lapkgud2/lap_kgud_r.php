...
$(document).ready(function() {
	...
	$("#cari").click(function() {
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapkgud2/tampil_data_r.php",
			data	: "kode1="+kode1+"&kode1a="+kode1a+"&kode2="+kode2+'&cabang='+cabang,
			beforeSend	: function(){		
...
echo "<div id='filter' align='center'>
	<fieldset>
		...
		<tr>
				...
				<td width='15%'>Sampai Dengan Tanggal</td>
				<td width='2%'>:</td>
				<td ><input type='text' name='kode1a' id='kode1a'  readonly/></td>
		</tr>
		<tr>
