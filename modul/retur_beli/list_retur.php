...
$(document).ready(function() {
	$("#data").load('modul/retur_beli/tampil_data_list_retur.php?cabang='+$("#textcabang").val());
...
<div id='form' align='center'><h2>LIST / CETAK RETUR<h3></div>
		...
		<table width='100%'>
			<tr>
				...
				$query	= "SELECT DISTINCT a.kode_retur,IFNULL(gab.`kodekonf_retur`,'') AS kodekonf_retur,a.cabang,a.tgl_retur 
										FROM retur_beli a
										LEFT JOIN (
												SELECT DISTINCT kodekonf_retur,kode_retur,kode_prinsipal,`namaprinsipal` FROM konfirm_retur_beli po
