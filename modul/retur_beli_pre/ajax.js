...
$(document).ready(function() {
	...
	function cari_nomor() {
		...
		$.ajax({
			type	: "POST",
			url		: "modul/retur_beli_pre/cari_nomor.php",
	...
	function tampil_data() {
		...
		$.ajax({
				type	: "POST",
				url		: "modul/retur_beli_pre/tampil_data.php",
	...
	$("#txt_kode_barang").autocomplete("modul/retur_beli_pre/list_barang.php", {
				width:100,
				//max: 10,
				scroll:true,
	});
	...
	function cari_kode() {
		...
		$.ajax({
			type	: "POST",
			url		: "modul/retur_beli_pre/cari_barang.php",
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: "POST",
			url		: "modul/retur_beli_pre/simpan.php",
			data	: "koderetur="+koderetur+
						"&tgl="+tgl+
						"&kode_brg="+kode_brg+
						"&supplier="+supplier+
	...
	$("#tambah_beli").click(function() {
		window.location.href='media.php?module=retur_beli_pre';
		$(".input").val('');
		kosong();
		cari_nomor();
		$("#txt_tgl_beli").focus();
