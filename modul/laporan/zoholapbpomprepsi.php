...
$yr1 = date('Y', strtotime($kode1));
	...
	//echo $q;
	//&nbsp
	$content = "<font size='3' align='left'><b>LAPORAN PSIKOTROPIKA DAN PRECURSOR, PT. SAPTA SARI TAMA<br> Periode : ".$tgl_awal." s/d ".$tgl_akhir."</b></font>
	...
	$content .=  cabDataPsiPre($p_data['Produk'],$cabang,$tgl_awal,$tgl_akhir,$p_data[batch],$p_data[expr])[0];
