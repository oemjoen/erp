...
$yr1 = date('Y', strtotime($kode1.'+ 1 months'));
	...
	WHERE  a.Cabang = '$cabang' AND (`Status BPB` = 'BKB Retur' 
	...
	//echo $q;
	//&nbsp
	$content = "<font size='3' align='left'><b>L A P O R A N    B K B<br>PT. SAPTA SARI TAMA<br> Periode : ".$tgl_awal." s/d ".$tgl_akhir."</b></font>
