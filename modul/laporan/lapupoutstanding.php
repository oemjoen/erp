...
$cabang = $_GET['cabang'];
	...
	if ($cabang =='KPS')
	{
		$q = "SELECT kode_beli,tgl_beli,kode_supplier,b.`namasupplier`,cabang,SUM(a.`jumlah_beli` * c.`hargajual`) AS total FROM pembelian_usulan a
	...
	$content .= "</table>";
		...
		header("Content-Disposition: attachment; filename=\"Laporan_Usulan_Outstanding_$tanggal.xls\"");
