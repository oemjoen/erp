...
//die;
	echo cabDataOOT($p_data['Produk'],$cabang,$tgl_awal,$tgl_akhir,$p_data[batch],$p_data[expr])[0];
	//echo cabDataPsiPre($p_data['Produk'],$cabang,$tgl_awal,$tgl_akhir,$p_data[batch],$p_data[expr])[2];die;
