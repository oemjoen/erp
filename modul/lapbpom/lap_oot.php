...
$(document).ready(function() {
	//$("#data").load('modul/lapbpom/tampil_data.php?cabang='+$("#textcabang").val());

	// $("#cbocab").change(function(){
	// var ambilcab = $("#cbocab").val();
	// $.ajax({
	// url: "modul/lapbpom/ambil_produk.php",
	...
	//	var kode2	= $("#cboprod").val();
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapbpom/tampil_data_oot.php",
			beforeSend	: function(){		
	...
	//	var kode2	= $("#cboprod").val();
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapbpom/tampil_data_oot_asli.php",
			beforeSend	: function(){		
				$("#data").html("<img src='loading.gif' />");			
			},				
			data	: "kode1="+kode1+"&kode2="+kode2+'&cabang='+cabang,
	...
	//	var kode2	= $("#cboprod").val();
		...
		window.location.href='modul/laporan/zoholapbpomoot.php?kode1='+kode1+'&kode2='+kode2+'&cabang='+cabang;
	});
...
<?php
echo "<div id='form' align='center'><h3>LAPORAN OOT<h3></div>";
echo "<div id='filter' align='center'>
	<fieldset>
		...
		<tr>
				...
				<button name='cari' id='cari'>CARI DATA 1</button> 
				<button name='cari2' id='cari2'>CARI DATA 2</button>
...
echo "<div id='cek' align='center'>
		<table>
		<tr><td><div id='tombol' align='center'><button name='exportexcel' id='exportexcel'>Export To Excel</button></div></td>
		</tr></table></<div>";
// echo "<div id='cek' align='center'>
		// <table>
		// <tr><td><div id='tombol' align='center'><button name='exportexcel' id='exportexcel'>Export To Excel</button></div></td>
		// <td><div id='tombol' align='center'><button name='exportpdf' id='exportpdf'>Export To PDF</button></div></td>
		// </tr></table></<div>";
?>