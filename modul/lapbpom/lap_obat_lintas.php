...
$(document).ready(function() {
	...
	$("#cari").click(function() {
		...
		if (kode2.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapbpom/tampil_lintas.php",
	...
	$("#exportexcel").click(function() {
		...
		window.location.href='modul/laporan/zoholapbpomlintas.php?kode1='+kode1+'&cabang='+cabang+'&kode2='+kode2;
	});
});
</script>
<style type="text/css">
...
<?php
echo "<div id='form' align='center'><h3>PELAPORAN OBAT LINTAS PROVINSI<h3></div>";
