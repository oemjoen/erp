...
$(document).ready(function() {
	...
	//	var kode2	= $("#cboprod").val();
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapbpom/tampil_data_psipre.php",
			beforeSend	: function(){		
	...
	//	var kode2	= $("#cboprod").val();
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapbpom/tampil_data_psipre_asli.php",
			beforeSend	: function(){		
				$("#data").html("<img src='loading.gif' />");			
			},				
			data	: "kode1="+kode1+"&kode2="+kode2+'&cabang='+cabang,
	...
	//	var kode2	= $("#cboprod").val();
		...
		window.location.href='modul/laporan/zoholapbpomprepsi.php?kode1='+kode1+'&kode2='+kode2+'&cabang='+cabang;
	});
...
<?php
echo "<div id='form' align='center'><h3>LAPORAN PSIKOTROPIKA DAN PRECURSOR<h3></div>";
echo "<div id='filter' align='center'>
	<fieldset>
		...
		<tr>
				...
				<button name='cari2' id='cari2'>CARI DATA</button>
