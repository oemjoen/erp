...
if( isset( $_POST['upload'] ) ){	
	...
	if ($jmlbaris > 0) {
			...
			$qDelete = "DELETE FROM `mst_stok_pusat`";
			mysql_query($qDelete);
			echo $qDelete."</br>";
			...
			$query = "INSERT INTO `mst_stok_pusat`(`kodeproduk`,`ed`,`stok`) VALUES ('$datakolom5','$datakolom6','$datakolom7');";
			echo $query."</br>";
	...
	header('location: ../../media.php?module=import_stok_pusat');
