...
$tablename = "kas_besar_report_all";
...
if (isset($_POST['submit'])) {
	...
	while (($data = fgetcsv($handle, 1000000, ",")) !== FALSE) {
		...
		$import="INSERT INTO $tablename
            (Cabang,Jurnal_ID,Tanggal,Transaksi,Kode_Transaksi,Keterangan,Debet,Credit,Saldo_Akhir,Bulan,Added_User,Added_Time,Jurnal_Acu,Jumlah_Acu,Counter,DIH,Tanggal_DIH,CR,DR,Ket2,Saldo_Awal,Jumlah,Penyetor)
				VALUES ('$datakolom0','$datakolom1','$datakolom2','$datakolom3','$datakolom4','$datakolom5','$datakolom6','$datakolom7','$datakolom8','$datakolom9','$datakolom10','$datakolom11','$datakolom12','$datakolom13','$datakolom14','$datakolom15','$datakolom16','$datakolom17','$datakolom18','$datakolom19','$datakolom20','$datakolom21','$datakolom22')";
		echo $import."</br>";
//		mysql_query($import) or die(mysql_error());
	...
	echo "<h2>Upload Kas Besar</h2><br />\n";
...
echo "<table id='theList' width='100%'>
		...
		$sql = "SELECT
					  Cabang,Jurnal_ID,Tanggal,Transaksi,Kode_Transaksi,Keterangan,Debet,Credit,
					  Saldo_Akhir,Bulan,Added_User,Added_Time,Jurnal_Acu,Jumlah_Acu,Counter,DIH,
					  Tanggal_DIH,CR,DR,Ket2,Saldo_Awal,Jumlah,Penyetor
					FROM kas_besar_report_all";				
		...
		while($r_data=mysql_fetch_array($query)){
			echo "<tr>
					...
					<td align='center'>$r_data[Debet]</td>
					<td align='center'>$r_data[Credit]</td>
