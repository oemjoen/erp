...
$(document).ready(function() {
	//$("#data").load('modul/lapzoho/tampil_data.php?cabang='+$("#textcabang").val());
	...
	$("#cari").click(function() {
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapzoho/tampil_data_cekstok.php",
	...
	$("#ceks").click(function() {
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapzoho/tampil_data_cekstok.php",
			data	: "kode1="+kode1+'&cabang='+cabang+'&sel='+sel,
			beforeSend	: function(){		
				$("#data").html("<img src='loading.gif' />");			
			},	
			success	: function(data){
	...
	$("#exportexcel").click(function() {
		...
		window.location.href='modul/laporan/zoholapmutasi.php?kode1='+kode1+'&cabang='+cabang;
	});
...
<div id='form' align='center'><h3>CEK STOK GUDANG<h3></div>
...
<?php
		...
		<!--		<button name='ceks' id='ceks'>CEK SELISIH</button> -->
