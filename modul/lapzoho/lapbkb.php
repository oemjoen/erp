...
$(document).ready(function() {
	...
	$("#cari").click(function() {
		...
		if (cabang.length==''){
	   	...
	   	$.ajax({
			type	: "GET",
			url		: "modul/lapzoho/tampil_data_bkb.php",
	...
	$("#exportexcel").click(function() {
		...
		window.location.href='modul/laporan/zoholapbelibkb.php?kode1='+kode1+'&kode2='+kode2+'&cabang='+cabang;
	});
...
<?php
echo "<div id='form' align='center'><h3>LAPORAN BKB<h3></div>";
